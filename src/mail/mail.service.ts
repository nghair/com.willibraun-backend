...
export class MailService {
  ...
  sendRegistrationConfirmation(
    registrationConfirmationEvent: RegistrationConfirmationEvent,
  ) {
    this.logger.log(
      'Sending Registration confirmation for :' +
        registrationConfirmationEvent.email,
    );
  ...
  async sendUserPasswordResetRequest(
    toEmail: string,
    name: string,
    token: string,
  ) {
